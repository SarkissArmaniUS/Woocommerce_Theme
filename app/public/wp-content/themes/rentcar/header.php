...
<body <?php body_class(); ?>>
	...
	<div id="page" class="site">
		<a class="skip-link screen-reader-text" href="#primary"><?php esc_html_e('Skip to content', 'healthstore'); ?></a>
					...
					<div class="col-md-4">
						<ul class="announcement-bar__list">
							...
							<li>
								...
								<a href="mailto:hello@healthstore.shop" class="text-decoration-none">mailto:hello@healthstore.shop</a>
							</li>
						</ul>
					</div>
				...
				<div class="container d-flex justify-content-center">
					<div class="row">
						<div class="col-12 d-flex justify-content-center">
							...
							<?php esc_html_e('Primary Menu', 'healthstore'); ?>
							</button>
						</div>
